...
export class SignupPage implements OnInit {
  ...
  constructor(private postprovider: PostProvider, private router: Router, 
    ...
    async register(){ // register method
      if (this.txtSponsorId == "" || this.txtSponsorId == null || this.txtUsername == "" || this.txtUsername == null ||
      this.txtFullname == "" || this.txtFullname == null ||  this.txtEmail == "" || this.txtEmail == null ||
       this.txtPass == "" || this.txtPass == null || this.txtConfirmPass == "" || this.txtConfirmPass == null ) {
        ...
        return new Promise(resolve => {
          ...
          let body = {
            aksi: 'register',
            txtSponsorId: this.txtSponsorId,
            txtUsername: this.txtUsername,
            txtFullname: this.txtFullname,
            txtEmail: this.txtEmail,
            txtMobile: this.display + this.txtMobile,
            txtPass: this.txtPass,
            txtConfPass: this.txtConfirmPass,
          ...
          this.postprovider.postData(body, 'process.php').subscribe(async data => {
            ...
            if(this.response == true){
              this.storage.set('msrno', this.id);
    ...
    async showLongToast() { // show toast message
      const toast = await this.toaster.create({
        message: 'Please enter a valid value in all the required fields before proceeding.',
        duration: 3000,
        position: 'bottom',
        color: 'medium',
    ...
    reset(){ // reset all values in ion-input (sign-up) Module
      this.txtSponsorId = null;
      this.txtUsername = null;
      this.txtFullname = null;
      this.txtEmail = null;
      this.txtMobile = null;
      this.txtPass = null;
    ...
    getcode(){
      let names  = this.countrycode;
      let splitted  = names.split('-');
      console.log(names);
      this.country = splitted[0];
      this.display = splitted[1];
    }
