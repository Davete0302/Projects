...
@Component({
  selector: 'app-sold-oro',
  templateUrl: './sold-oro.page.html',
  styleUrls: ['./sold-oro.page.scss'],
})
export class SoldOroPage implements OnInit {
  ...
  constructor(private postPvdr: PostProvider, private router: Router, private activatedRoute: ActivatedRoute ,
    ...
    DownloadPDF(){
      const route= 'download-report/' + 'sold-oro';
      this.router.navigateByUrl(route);
    }
    loadReport() {
      return new Promise(resolve => {
        let body = {
          aksi : 'details_exchange',
          limit : this.limit,
          start : this.start,
          id : this.id,
          counts: this.counts,
